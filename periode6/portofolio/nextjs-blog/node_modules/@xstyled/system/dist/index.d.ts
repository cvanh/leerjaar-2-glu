...
declare type SynthesizedPath<T extends {}> = {
    [P in keyof T]: (T[P] extends {
        [key: string]: any;
        [key: number]: any;
    } ? `${string & P}` | `${string & P}.${SynthesizedPath<T[P]>}` : `${string & P}`) | (number & P);
}[T extends any[] ? number & keyof T : keyof T];
declare type ThemeNamespaceValue<K extends string, T extends ITheme> = SynthesizedPath<T[K]>;
...
declare type StyleGeneratorProps<T extends object> = T extends StyleGenerator<infer T> ? T : never;
...
declare const compose: <TProps = {}>(...generators: StyleGenerator[]) => StyleGenerator<TProps>;
...
interface TransitionDurationProps<T extends ITheme = Theme> {
    transitionDuration?: SystemProp<ThemeDuration<T> | CSS.Property.TransitionDuration, T>;
}
...
interface TransitionDelayProps<T extends ITheme = Theme> {
    transitionDelay?: SystemProp<ThemeDuration<T> | CSS.Property.TransitionDelay, T>;
}
...
declare const getAnimation: ThemeGetter<string>;
...
interface AnimationDurationProps<T extends ITheme = Theme> {
    animationDuration?: SystemProp<ThemeDuration<T> | CSS.Property.AnimationDuration, T>;
}
...
declare const getColor: ThemeGetter<string>;
...
interface BorderTopWidthProps<T extends ITheme = Theme> {
    borderTopWidth?: SystemProp<ThemeBorderWidth<T> | CSS.Property.BorderTopWidth, T>;
}
...
interface BorderRightWidthProps<T extends ITheme = Theme> {
    borderRightWidth?: SystemProp<ThemeBorderWidth<T> | CSS.Property.BorderRightWidth, T>;
}
...
interface BorderBottomWidthProps<T extends ITheme = Theme> {
    borderBottomWidth?: SystemProp<ThemeBorderWidth<T> | CSS.Property.BorderBottomWidth, T>;
}
...
interface BorderLeftWidthProps<T extends ITheme = Theme> {
    borderLeftWidth?: SystemProp<ThemeBorderWidth<T> | CSS.Property.BorderLeftWidth, T>;
}
...
declare const getRadius: ThemeGetter<string>;
...
declare const getRingWidth: ThemeGetter<string>;
...
declare const getShadow: ThemeGetter<string>;
...
declare const getZIndex: ThemeGetter<string>;
...
declare const getInset: ThemeGetter<string>;
...
declare const getSpace: ThemeGetter<string>;
declare type MarginProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.Margin, T>;
interface MarginProps<T extends ITheme = Theme> {
    margin?: MarginProp<T>;
    m?: MarginProp<T>;
}
declare const margin: StyleGenerator<{}>;
declare type MarginTopProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.MarginTop, T>;
...
declare type MarginRightProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.MarginRight, T>;
...
declare type MarginBottomProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.MarginBottom, T>;
...
declare type MarginLeftProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.MarginLeft, T>;
...
interface MarginXProps<T extends ITheme = Theme> {
    mx?: SystemProp<ThemeSpace<T> | (CSS.Property.MarginLeft & CSS.Property.MarginRight), T>;
}
declare const mx: StyleGenerator<MarginXProps<Theme>>;
interface MarginYProps<T extends ITheme = Theme> {
    my?: SystemProp<ThemeSpace<T> | (CSS.Property.MarginTop & CSS.Property.MarginBottom), T>;
}
declare const my: StyleGenerator<MarginYProps<Theme>>;
declare type PaddingProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.Padding, T>;
...
declare type PaddingTopProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.PaddingTop, T>;
...
declare type PaddingRightProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.PaddingRight, T>;
...
declare type PaddingBottomProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.PaddingBottom, T>;
...
declare type PaddingLeftProp<T extends ITheme> = SystemProp<ThemeSpace<T> | CSS.Property.PaddingLeft, T>;
...
interface PaddingXProps<T extends ITheme = Theme> {
    px?: SystemProp<ThemeSpace<T> | (CSS.Property.PaddingLeft & CSS.Property.PaddingRight), T>;
}
declare const px: StyleGenerator<PaddingXProps<Theme>>;
interface PaddingYProps<T extends ITheme = Theme> {
    py?: SystemProp<ThemeSpace<T> | (CSS.Property.PaddingTop & CSS.Property.PaddingBottom), T>;
}
...
declare const getSize: ThemeGetter<string>;
...
declare type MaxWidthProp<T extends ITheme> = SystemProp<ThemeSize<T> | CSS.Property.MaxWidth, T>;
...
declare type MaxHeightProp<T extends ITheme> = SystemProp<ThemeSize<T> | CSS.Property.MaxHeight, T>;
...
declare type MinHeightProp<T extends ITheme> = SystemProp<ThemeSize<T> | CSS.Property.MinHeight, T>;
...
declare const getTransform: ThemeGetter<string>;
...
interface LetterSpacingProps<T extends ITheme = Theme> {
    letterSpacing?: SystemProp<ThemeLetterSpacing<T> | CSS.Property.LetterSpacing, T>;
}
